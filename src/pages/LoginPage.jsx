    ...
    return (
        <>
            <div className="container" id="hero">
                <div
                    className="row flex-lg-row align-items-center py-4"
                    id="hero-info"
                >
                    <div className="col-12 col-lg-5 mx-auto">
                        ...
                        <h3 className="loginBody suez-one-regular">
                            Effortless workout tracker that helps you focus on
            ...
            >
                ...
                <div className="row justify-content-center py-4 g-2">
                    <div
                        className="col-11 col-sm-5 col-md-4 col-xl-3"
                ...
                <div
                    className="btn-group col-10 col-sm-7 col-md-5 py-3"
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            Would you like us to send you a Password Reset
                            Email?{' '}
                        </div>
